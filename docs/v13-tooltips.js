...
window.addEventListener('load',()=>{if(document.querySelector('script[data-v15-loader]'))return;const s=document.createElement('script');s.src='v15.js?v=15.2';s.dataset.v15Loader='1';s.onload=()=>{if(document.querySelector('script[data-v16-loader]'))return;const n=document.createElement('script');n.src='v16.js?v=16.2';n.dataset.v16Loader='1';document.body.appendChild(n);};document.body.appendChild(s);});